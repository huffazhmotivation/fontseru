...
let brotli_lib_decode = require("brotli-lib/decode");
...
async function decompress(data) {
	...
	return (0, brotli_lib_decode.brotliDecode)(data);
}
...
async function woff2Decode(data) {
	...
	const header = readHeader(new Buffer(input), input.byteLength);
...
//#endregion
exports.woff2Decode = woff2Decode;
exports.woffDecode = woffDecode;