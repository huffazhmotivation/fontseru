...
let brotli_lib_encode = require("brotli-lib/encode");
...
async function woffEncode(data, options) {
	...
	for (let i = 0; i < numTables; i++) {
		const offset = SFNT_HEADER_SIZE$1 + i * SFNT_ENTRY_SIZE$1;
		tables.push({
	...
	let totalSfntSize = SFNT_HEADER_SIZE$1 + numTables * SFNT_ENTRY_SIZE$1;
...
function woff2Encode(data, options) {
	...
	const compressed = (0, brotli_lib_encode.brotliEncode)(tableDataStream, {
		quality,
		mode: brotli_lib_encode.EncoderMode.FONT
	});
...
//#endregion
exports.woff2Encode = woff2Encode;
exports.woffEncode = woffEncode;